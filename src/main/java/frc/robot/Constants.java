...
public final class Constants {
  ...
  public static class ClimberConstants{
    ...
    public static final double encoderOffset = 23.5/360.0; //returns a value from 1 to 0
    public static final double reverseEncoderLimitDegrees = 153.0;

    public static final double rawEncoderDegPhysLB = -205.0;
    public static final double rawEncoderDegPhysUB = 17.0;

    public static final double rawEncoderDegCalcLB = rawEncoderDegPhysLB - 30.0;
    public static final double rawEncoderDegCalcUB = rawEncoderDegPhysUB + 30.0;
  }
